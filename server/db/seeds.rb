...
admin = User.new({:first_name => "Dominic", :last_name => "Lapointe", :user_name => "Doum", :email => "dom.dlapointe@gmail.com", :password => "12345", :password_confirmation => "12345", :title => "Programmer"})
admin.roles = [:admin]
admin.save
